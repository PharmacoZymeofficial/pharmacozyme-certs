...
import OfficialSearch from "@/components/OfficialSearch";
import VerificationResult from "@/components/VerificationResult";
import OfficialDatabaseCards from "@/components/OfficialDatabaseCards";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface">
      ...
      <main className="flex-1 pb-20">
        ...
        {/* ── DATABASE CARDS ── */}
        <OfficialDatabaseCards onDatabaseSelect={handleDatabaseSelect} />

        {/* ── RESULT SECTION ── */}
        <div ref={resultRef}>
          {mismatch && (
            <section className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
              <CrossCategoryHint actualCategory={mismatch.actualCategory} certId={mismatch.certId} currentCategory="Official" />
            </section>
          )}
